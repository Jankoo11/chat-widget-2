...
\f0\fs24 \cf0 // Interactive Chat Widget for n8n\
(function() \{\
...
\
    ...
    widgetStyles.textContent = `\
        .chat-assist-widget \{\
            ...
            --chat-color-border: var(--chat-widget-border, #4d4e4f);\
            --chat-shadow-sm: 0 1px 3px rgba(0, 174, 239, 0.1);\
            --chat-shadow-md: 0 4px 6px rgba(0, 174, 239, 0.15);\
            --chat-shadow-lg: 0 10px 15px rgba(0, 174, 239, 0.2);\
            --chat-radius-sm: 8px;\
            --chat-radius-md: 12px;\
            --chat-radius-lg: 20px;\
...
\
    ...
    widgetRoot.style.setProperty('--chat-widget-border', '#4d4e4f'); // Set custom border color\
\
    // Create chat panel\
    ...
    const welcomeScreenHTML = `\
        <div class="chat-header">\
            ...
            <button class="chat-close-btn">\'d7</button>\
        </div>\
        <div class="chat-welcome">\
            ...
            <button class="chat-start-btn">\
                ...
                Za\uc0\u269 ni klepet\
            </button>\
            <p class="chat-response-time">$\{settings.branding.responseTimeText\}</p>\
        </div>\
        <div class="user-registration">\
            <h2 class="registration-title">Vnesite podatke za za\uc0\u269 etek klepeta</h2>\
            <form class="registration-form">\
                <div class="form-field">\
                    <label class="form-label" for="chat-user-name">Ime</label>\
                    <input type="text" id="chat-user-name" class="form-input" placeholder="Va\'9ae ime" required>\
                    <div class="error-text" id="name-error"></div>\
                </div>\
                <div class="form-field">\
                    <label class="form-label" for="chat-user-email">Email</label>\
                    <input type="email" id="chat-user-email" class="form-input" placeholder="Va\'9a email naslov" required>\
...
\
    ...
    const chatInterfaceHTML = `\
        <div class="chat-body">\
            ...
            <div class="chat-controls">\
                <textarea class="chat-textarea" placeholder="Vnesite sporo\uc0\u269 ilo..." rows="1"></textarea>\
    ...
    launchButton.innerHTML = `\
        ...
        <span class="chat-launcher-text">Rabi\'9a pomo\uc0\u269 ?</span>`;\
    \
    // Add elements to DOM\
